...
export default function ShiftWorld() {
  ...
  useEffect(() => {
    ...
    const quadMat = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          vec3 mintC = vec3(0.61, 0.96, 0.83);
          vec3 emberC = vec3(1.0, 0.30, 0.18);
    ...
    const solids: THREE.Mesh[] = []
    {
      ...
      const mintMat = new THREE.MeshStandardMaterial({ color: 0x9cf5d3, wireframe: true, transparent: true, opacity: 0.26 })
